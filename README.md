...
**統整最新版 V23.2.0** 在 [`gas/unified/`](gas/unified/)。在 V23.1 資料夾進度追蹤之上，新增標準工作樣板（停車場／門禁／訪客等）與收件匣「今日待回報／每日摘要」。
...
- [V23.1 資料夾進度追蹤](docs/V23.1_資料夾進度追蹤.md)
- [V23.2 標準工作樣板](docs/V23.2_標準工作樣板.md)
